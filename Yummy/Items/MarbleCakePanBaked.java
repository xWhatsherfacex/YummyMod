...
public class MarbleCakePanBaked extends Item {
	public MarbleCakePanBaked(){
		setUnlocalizedName("MarbleCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_Marble");
		}
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World p_77659_2_, EntityPlayer player) {
		...
		return new ItemStack(YummyItems.CakeSheet,1, 4);
    }
