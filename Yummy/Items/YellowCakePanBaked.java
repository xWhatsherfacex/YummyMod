...
public class YellowCakePanBaked extends Item {
	public YellowCakePanBaked(){
		setUnlocalizedName("YellowCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_Yellow");
		}
