...
public class PlainCakePanBaked extends Item {
	public PlainCakePanBaked(){
		setUnlocalizedName("PlainCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_Plain");
		}
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World p_77659_2_, EntityPlayer player) {
		...
		return new ItemStack(YummyItems.CakeSheet, 1,3);
    }
