...
public class ChocolateCakePanBaked extends Item {
	public ChocolateCakePanBaked(){
		setUnlocalizedName("ChocolateCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "ChocolateCakePanBaked");
		}
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World p_77659_2_, EntityPlayer player) {
		...
		return new ItemStack(YummyItems.CakeSheet,1, 2);
    }
