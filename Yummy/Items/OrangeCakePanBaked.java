...
public class OrangeCakePanBaked extends Item {
	public OrangeCakePanBaked(){
		setUnlocalizedName("OrangeCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_Orange");
		}
