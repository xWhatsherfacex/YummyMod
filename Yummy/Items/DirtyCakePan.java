...
public class DirtyCakePan extends Item {
	public DirtyCakePan(){
		setUnlocalizedName("DirtyCakePan")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "DirtyCakePan");
		}
        ...
        else
        {
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (world.getBlock(i, j, k).getMaterial() == Material.water)
                {
                    ...
                    {
                        player.dropPlayerItemWithRandomChoice(new ItemStack(YummyItems.cakepan), false);
                    }
                }
            }
