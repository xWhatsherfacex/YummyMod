...
public class LightBlueCakePanBaked extends Item {
	public LightBlueCakePanBaked(){
		setUnlocalizedName("LightBlueCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_LightBlue");
		}
