...
public class BlueCakePanBaked extends Item {
	public BlueCakePanBaked(){
		setUnlocalizedName("BlueCakePanBaked")
		.setCreativeTab(Yummy.tabYummy)
		.setMaxStackSize(1)
		.setTextureName(Yummy.MODID + ":" + "CakePanBaked_Blue");
		}
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World p_77659_2_, EntityPlayer player) {
		...
		return new ItemStack(YummyItems.CakeSheet,1,11);
    }
