...
public class YummyPigDropHandler{
	...
	public static int dropped;
		...
		public void onEntityDrop(LivingDropsEvent event){
			...
			if (((EntityAgeable) event.entity).getGrowingAge() < 0)
				event.entityLiving.entityDropItem(new ItemStack(YummyBlocks.DeadBabyPigBlock), 1);
                        else
                                event.entityLiving.entityDropItem(new ItemStack(YummyBlocks.DeadPigBlock), 1);
                        }
