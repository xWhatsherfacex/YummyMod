...
public class CherryLeaves extends BlockLeavesBase implements IPlantable
{
    Random random;
    public IIcon[] fastIcons;
    public IIcon[] fancyIcons;
    public static String[] textureNames = new String[] { "CherryLeaves", "CherryLeaves_ripe"};
    ...
    public CherryLeaves()
    {
        ...
        this.setBlockName("CherryLeaves");
    ...
    public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player)
    {
        if (!world.isRemote)
        {
            ...
            if (meta >= 12)
            {
                ...
                EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(YummyItems.Cherry, 6));
    ...
    {
        if (plant instanceof CherryLeaves)
