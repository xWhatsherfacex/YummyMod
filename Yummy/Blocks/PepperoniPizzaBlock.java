...
public class PepperoniPizzaBlock extends BlockContainer {
	...
	public PepperoniPizzaBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("PepperoniPizzaBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "PepperoniPizzaBlock");
        }
    ...
    {
        this.blockIcon = icon.registerIcon(Yummy.MODID + ":" + "PizzaSide");
        this.inside = icon.registerIcon(this.getTextureName() + "_top");
        this.top = icon.registerIcon(Yummy.MODID + ":" + "PizzaInner");
        this.bottom = icon.registerIcon(Yummy.MODID + ":" + "PieBottom");
    }
    ...
    {
        return YummyItems.PepperoniPizza;
    }
}
