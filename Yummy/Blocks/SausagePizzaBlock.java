...
public class SausagePizzaBlock extends BlockContainer {
	...
	public SausagePizzaBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("SausagePizzaBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "SausagePizzaBlock");
        }
    ...
    {
        return YummyItems.SausagePizza;
    }
}
