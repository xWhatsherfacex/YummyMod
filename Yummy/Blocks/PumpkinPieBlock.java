...
public class PumpkinPieBlock extends BlockContainer {
	...
	public PumpkinPieBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("PumpkinPie");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "PumpkinPie");
        }
