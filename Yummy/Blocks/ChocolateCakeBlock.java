...
public class ChocolateCakeBlock extends BlockContainer {
	...
	public ChocolateCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("ChocolateCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "chocolatecake");
        }
    ...
    {
        return YummyItems.ChocolateCake;
    }
}
