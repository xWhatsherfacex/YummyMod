...
import com.rnh.Yummy.World.Trees.WorldGenCoconutTree;
import com.rnh.Yummy.World.Trees.WorldGenMangoTree;
import com.rnh.Yummy.World.Trees.WorldGenPapayaTree;
...
public class TropicalSapling extends BlockSapling{

    public static final String[] Names = new String[] {"BananaSapling", "CoconutSapling", "PapayaSapling","MangoSapling"};
    private static final IIcon[] Icons = new IIcon[Names.length];
    

    public TropicalSapling()
    {
        float f = 0.4F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, f * 2.0F, 0.5F + f);
        this.setBlockName("Saplings");
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random)
    {
        ...
        {
            case 0:           
            	object = new com.rnh.Yummy.World.Trees.WorldGenBananaTree();
                break;
            case 1:
            	object = new WorldGenCoconutTree();
                break;
            case 2:
            	object = new WorldGenPapayaTree();
                break;
            case 3:
            	object = new WorldGenMangoTree();
                break;
            default:
                break;
        }
