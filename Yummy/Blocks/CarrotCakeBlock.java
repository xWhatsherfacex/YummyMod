...
public class CarrotCakeBlock extends BlockContainer {
	...
	public CarrotCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("CarrotCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "CarrotCake");
        }
