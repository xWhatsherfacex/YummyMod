...
public class RedVelvetCakeBlock extends BlockContainer {
	...
	public RedVelvetCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("RedVelvetCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "RedVelvetCake");
        }
