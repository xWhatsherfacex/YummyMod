...
public class BananaBunch extends BlockCocoa{

		@SideOnly(Side.CLIENT)
		
		public static final String[] Names = new String[] {"BananaBunch", "BananaBunch_Ripe"};
	    ...
	    public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player)
	    {
	        if (!world.isRemote)
	        {
	            ...
	            if (meta >= 7)
	            {
	                ...
	                EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(YummyItems.Banana, 4));
