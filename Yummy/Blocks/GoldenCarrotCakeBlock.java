...
public class GoldenCarrotCakeBlock extends BlockContainer {
	...
	public GoldenCarrotCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("CarrotCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "GoldenCarrotCake");
        }
    ...
    {
        return YummyItems.GoldenCarrotCake;
    }
}
