...
public class MarbleCakeBlock extends BlockContainer {
	...
	public MarbleCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("MarbleCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "MarbleCake");
        }
