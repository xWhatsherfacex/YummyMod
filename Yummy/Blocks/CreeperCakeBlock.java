...
public class CreeperCakeBlock extends BlockContainer {
	...
	public CreeperCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("CreeperCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "CreeperCake");
        }
