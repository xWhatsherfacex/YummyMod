...
public class BlackForrestCakeBlock extends BlockContainer {
	...
	public BlackForrestCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("BlackForrestCake");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "BlackForrestCake");
        }
    ...
    {
        return YummyItems.BlackForrestCake;
    }
}
