...
public class BiPrideCakeBlock extends BlockContainer {
	...
	public BiPrideCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("BiPrideCakeBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "BiPrideCake");
        }
