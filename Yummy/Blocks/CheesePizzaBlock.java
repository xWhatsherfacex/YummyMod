...
public class CheesePizzaBlock extends BlockContainer {
	...
	public CheesePizzaBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("CheesePizzaBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "CheesePizza");
        }
