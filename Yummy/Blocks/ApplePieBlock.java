...
public class ApplePieBlock extends BlockContainer {
	...
	public ApplePieBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("ApplePie");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "ApplePie");
        }
