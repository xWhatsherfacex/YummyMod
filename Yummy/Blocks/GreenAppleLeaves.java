...
public class GreenAppleLeaves extends BlockLeavesBase implements IPlantable
{
    Random random;
    public IIcon[] fastIcons;
    public IIcon[] fancyIcons;
    public static String[] textureNames = new String[] { "GreenAppleLeaves","GreenAppleLeaves_ripe" };

    public GreenAppleLeaves()
    {
        ...
        this.setBlockName("GreenAppleLeaves");
    ...
    public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player)
    {
        if (!world.isRemote)
        {
            ...
            if (meta >= 12)
            {
                ...
                EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(YummyItems.GreenApple,3));
    ...
    {
        if (plant instanceof GreenAppleLeaves)
