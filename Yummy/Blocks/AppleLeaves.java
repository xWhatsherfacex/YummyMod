...
public class AppleLeaves extends BlockLeavesBase implements IPlantable
{
    Random random;
    public IIcon[] fastIcons;
    public IIcon[] fancyIcons;
    public static String[] textureNames = new String[] { "AppleLeaves", "AppleLeaves_ripe"};
    ...
    public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player)
    {
        if (!world.isRemote)
        {
            ...
            if (meta >= 12)
            {
                ...
                EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(Items.apple, 3, meta - 12));
    ...
    {
        if (plant instanceof AppleLeaves)
