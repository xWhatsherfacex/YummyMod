...
public class StrawberryBush extends BlockCrops{
	...
	protected Item func_149866_i(){
		return YummyItems.StrawberrySeeds;
	}
    ...
    public void onBlockClicked (World world, int x, int y, int z, EntityPlayer player)
    {
        if (!world.isRemote)
        {
            ...
            if (meta >= 7)
            {
                ...
                EntityItem entityitem = new EntityItem(world, player.posX, player.posY - 1.0D, player.posZ, new ItemStack(YummyItems.Strawberry,5));
