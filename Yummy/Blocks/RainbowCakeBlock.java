...
public class RainbowCakeBlock extends BlockContainer {
	...
	public RainbowCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("RainbowCakeBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "RainbowCake");
        }
