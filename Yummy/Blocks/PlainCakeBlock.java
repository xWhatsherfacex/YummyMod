...
public class PlainCakeBlock extends BlockContainer {
	...
	public PlainCakeBlock(String string, Material material) {
		super(Material.cake);
		this.setBlockName("PlainCakeBlock");
        this.setTickRandomly(true);
        this.setStepSound(soundTypeCloth);
        this.setHardness(1);
        this.setBlockTextureName(Yummy.MODID + ":" + "PlainCake");
        }
