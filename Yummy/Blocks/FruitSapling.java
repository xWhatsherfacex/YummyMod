...
public class FruitSapling extends BlockSapling{

    public static final String[] Names = new String[] {"CherrySapling"};
    ...
    public FruitSapling()
    {
        ...
        this.setBlockName("FruitSaplings");
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random)
    {
        ...
        {
            case 0:           
            	object = new com.rnh.Yummy.World.Trees.WorldGenCherryTree(Blocks.log, YummyBlocks.CherryLeaves ,0,0, false, 4, 3, false);
                break;
            case 1:
                break;
            case 2:
