...
public class WorldGenMangoTree extends WorldGenAbstractTree {
    ...
    public WorldGenMangoTree(int strengthRand, int bMax, double offset) {
        super(false);
    ...
    public void generateTop(World world, int x, int y, int z) {
    	this.buildBlock(world, x - 1 , y  , z , YummyBlocks.MangoBlock, 1);
        this.buildBlock(world, x + 1 , y  , z , YummyBlocks.MangoBlock, 1);
        this.buildBlock(world, x , y  , z - 1 , YummyBlocks.MangoBlock, 1);
        this.buildBlock(world, x , y  , z + 1 , YummyBlocks.MangoBlock, 1);
