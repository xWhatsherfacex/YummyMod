...
public class WorldGenYellowAppleTree extends WorldGenAbstractTree
{
    ...
    public WorldGenYellowAppleTree(Block wood, Block leaves, int metaWood, int metaLeaves)
    {
        this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
    }

    public WorldGenYellowAppleTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        ...
        if (y >= 1 && y + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, (BlockSapling)YummyBlocks.AppleSapling);
                if (isSoil && y < 256 - l - 1)
                {
                        ...
                        for (i2 = x - l1; i2 <= x + l1; ++i2)
                        {
                            ...
                            for (int k2 = z - l1; k2 <= z + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(world, i2, k1, k2, YummyBlocks.YellowAppleLeaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
