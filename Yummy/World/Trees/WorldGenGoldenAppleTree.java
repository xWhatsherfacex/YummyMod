...
public class WorldGenGoldenAppleTree extends WorldGenAbstractTree
{
    ...
    public WorldGenGoldenAppleTree(Block wood, Block leaves, int metaWood, int metaLeaves)
    {
        this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
    }

    public WorldGenGoldenAppleTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
                        ...
                        for (i2 = x - l1; i2 <= x + l1; ++i2)
                        {
                            ...
                            for (int k2 = z - l1; k2 <= z + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(world, i2, k1, k2, YummyBlocks.GoldenAppleLeaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
