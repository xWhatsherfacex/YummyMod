...
public class WorldGenPapayaTree extends WorldGenAbstractTree {
    private int strengthRand;
    private int bMax;
    private double offset;

    public WorldGenPapayaTree() {
        this(35, 10, 1.3);
    }

    public WorldGenPapayaTree(int strengthRand, int bMax, double offset) {
        super(false);
    ...
    public void generateTop(World world, int x, int y, int z) {
    	this.buildBlock(world, x - 1 , y  , z , YummyBlocks.PapayaBlock, 1);
        this.buildBlock(world, x + 1 , y  , z , YummyBlocks.PapayaBlock, 1);
        this.buildBlock(world, x , y  , z - 1 , YummyBlocks.PapayaBlock, 1);
        this.buildBlock(world, x , y  , z + 1 , YummyBlocks.PapayaBlock, 1);
